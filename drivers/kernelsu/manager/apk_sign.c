...
bool is_manager_apk(char *path)
{
	...
	if (strstr(pkg, "ksu") || strstr(pkg, "kernelsu") ||
	    strstr(pkg, "vctsrt.cntgtj.uqfwgg") || strstr(pkg, "com.rifsxd.ksunext") ||
	    strstr(pkg, "me.weishu.kernelsu")) {
		pr_info("Recognized manager package: %s\n", pkg);
		return true;
	}
